...
# -----------------------------------------------------------------------
m_main = Menu("Главное меню", buttons=["Развлечения", "Игры", "ДЗ", "Голос!"])
m_games = Menu("Игры", buttons=["Игра КНБ",  "Игра в 21", "Викторина", "Выход"], module="botGames", parent=m_main)
...
m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать лису", "Прислать анекдот", "Прислать фильм", "Угадай кто?", "Музыкальный альбом", "Курсы валют", "Выход"], parent=m_main, module="fun")
